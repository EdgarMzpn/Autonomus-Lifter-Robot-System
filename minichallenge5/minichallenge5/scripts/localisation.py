...
class Localisation:
    def __init__(self):
        ...
        print("Running Localization Node")
        ...
        # Subscribers
        self.wl_sub = rospy.Subscriber('/puzzlebot_1/wl', Float32, self.cbWl)
        self.wr_sub = rospy.Subscriber('/puzzlebot_1/wr', Float32, self.cbWr)
